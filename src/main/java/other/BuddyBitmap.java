...
public class BuddyBitmap {
    ...
    public BuddyBitmap(int n) {
        BigDecimal balance = new BigDecimal("1.15");
        BigDecimal balance2 = new BigDecimal("0.36");
        BigDecimal balance3 = new BigDecimal("245");
        this.n = n;
    ...
    public static void main(String[] args) {
        BuddyBitmap sol = new BuddyBitmap(4);
